        ...
        <div className="w-full overflow-hidden">
            ...
            <section className="bg-white py-10">
                <div className="mx-auto max-w-7xl px-6 text-center">
                    ...
                    >
                        The Cultural Highlights Tour gives you a fascinating look into some of the
                        most renowned archaeological sites and historical places in Sri Lanka.
                        On your tour, you get the chance to visit a magnificent rock fortress and
                        a sacred cave temple both of which are UNESCO World Heritage Sites.
                        Additionally, explore the central hill capital and gain the blessings of
                        Buddha, Dhamma & Sangha (the triple gem).
                    </p>
                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div className="text-left">
                                ...
                                <p className="text-xl font-bold">03 Days</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-12 space-y-6">
                        ...
                        <div data-aos="fade-up" data-aos-delay="150" className="overflow-hidden rounded-lg border bg-white shadow">
                            <button
                                ...
                                className="flex w-full items-center justify-between bg-gray-100 px-6 py-5 text-left font-semibold text-[#0A3A5E]"
                            >
                                <span>DAY 2 – KANDY | SIGIRIYA | DAMBULLA | MATALE | KANDY</span>
                                <span>{day2 ? "−" : "+"}</span>
                            </button>
                            ...
                            {day2 && (
                                <div className="space-y-4 px-6 py-6 text-gray-700 leading-relaxed">
                                    ...
                                    <p>
                                        Thereafter, visit a spice garden in Matale, and learn about the therapeutic values of spices and the various cultivation process employed, after which one can enjoy a revitalising cup of herbal tea. The more adventurous type in need of a more authentic town experience can look forwards to wandering through the bustling streets filled with exotic sights and sounds.
                                    </p>
                        ...
                        >
                            <button
                                ...
                                className="flex w-full items-center justify-between bg-gray-100 px-6 py-5 text-left font-semibold text-[#0A3A5E]"
                            >
                                <span>DAY 3 – KANDY | PERADENIYA | PINNAWALA | SELECTED BEACH RESORT</span>
                                <span>{day3 ? "−" : "+"}</span>
                            </button>
...
export default CulturalHighlightsTour;
