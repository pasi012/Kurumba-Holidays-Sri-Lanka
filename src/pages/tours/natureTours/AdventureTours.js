...
import aboutHero from "../../../assets/adventuretours.jpg";

import dhamma from "../../../assets/Kithulgala1.jpg";
import sigiriya from "../../../assets/Bentota1.jpg";
import kandy from "../../../assets/colomboKithulgala1.jpg";
import temple from "../../../assets/adventuretours.jpg";
        ...
        <div className="w-full overflow-hidden">
            ...
            <section className="relative h-[40vh] w-full">
                ...
                <div className="relative z-10 flex h-full flex-col items-center justify-center text-center text-white">
                    ...
                    >
                        Where Adventure Meets Sri Lanka’s Living Heritage
                    </p>
                </div>
            </section>
            ...
            <section className="bg-white -py-2">
                <div className="mx-auto max-w-7xl px-6 text-center">
                    ...
                    >
                        If you’re an adrenaline junkie at heart, stay true to yourself and experience pulse racing adventure tourism in Sri Lanka. From white water rafting in the quaint little town of Kitulgala, jet skiing in Negombo, discovering mysterious shipwrecks off Colombo, teeming with marine life to riding the waves at Arugam Bay, one of the world’s top surf destinations, the choices are truly limitless!
                    </p>
