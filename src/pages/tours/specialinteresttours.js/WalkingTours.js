...
import sigiriya from "../../../assets/WalkingTours.jpg";
import kandy from "../../../assets/WalkingTours2.jpg";
import temple from "../../../assets/WalkingTours3.jpg";

import related1 from "../../../assets/BawaTour.jpg";
        ...
        <div className="w-full overflow-hidden">
            ...
            <section className="relative h-[40vh] w-full">
                ...
                <div className="relative z-10 flex h-full flex-col items-center justify-center text-center text-white">
                    ...
                    >
                        Journey Through Sri Lanka’s Calm
                    </p>
                </div>
            </section>
            ...
            <section className="bg-white -py-2">
                <div className="mx-auto max-w-7xl px-6 text-center">
                    ...
                    >
                        Embark on our city tour of Colombo and learn about the rich colonial history behind the Dutch Complex, home to novel restaurants and high-end concept stores. Walk along the bustling roads of Pettah, and explore various alleys selling everything from fresh produce to exquisite sarees. Tease your taste buds with spicy street food while listening to riveting stories from the past by Mark Forbes, your gracious host for the day!
                    </p>
