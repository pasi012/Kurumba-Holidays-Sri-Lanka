...
import aboutHero from "../../../assets/BawaTour.jpg";

import dhamma from "../../../assets/BawaTour1.jpg";
import sigiriya from "../../../assets/BawaTour2.jpg";
import kandy from "../../../assets/BawaTour3.JPG";
import temple from "../../../assets/BawaTour.jpg";

import related1 from "../../../assets/WalkingTours.jpg";
import related2 from "../../../assets/CookingbyColours.jpg";
        ...
        <div className="w-full overflow-hidden">
            ...
            <section className="bg-white -py-2">
                <div className="mx-auto max-w-7xl px-6 text-center">
                    ...
                    >
                        One of the original proponents of Tropical Modernism, Geoffrey Bawa is an icon who created a new architectural and aesthetic identity for the island. Our Bawa Tours offers you the chance to experience his iconic legacy which features a seamless blend between nature and post-colonial architecture. Prominent sites explored will include his beloved home, the Lunganga Estate and a series of hotels located across the island.
                    </p>
                        ...
                        <SwiperSlide>
                            <div className="group overflow-hidden rounded-xl shadow-lg">
                                ...
                                <div className="bg-[#083A5E] p-6 text-center">
                                    ...
                                    <button
                                        onClick={() => navigate(`/tours/special-interest-tours/cooking-by-colours`)}
                                        className="border-b-2 border-[#00A9C7] pb-1 text-sm uppercase tracking-widest text-[#00A9C7] hover:text-white">
                                        View Details
                                    </button>
                                </div>
