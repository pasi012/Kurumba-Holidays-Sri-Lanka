...
import aboutHero from "../../../assets/CookingbyColours.jpg";

import dhamma from "../../../assets/CookingbyColours1.jpg";
import sigiriya from "../../../assets/CookingbyColours2.jpg";
import kandy from "../../../assets/CookingbyColours3.jpg";
import temple from "../../../assets/CookingbyColours.jpg";

import related1 from "../../../assets/WalkingTours.jpg";
import related2 from "../../../assets/BawaTour.jpg";
import related3 from "../../../assets/FeminaTour.jpg";
        ...
        <div className="w-full overflow-hidden">
            ...
            <section className="bg-white -py-2">
                <div className="mx-auto max-w-7xl px-6 text-center">
                    ...
                    >
                        Embark on a gastronomic culinary tour in Sri Lanka and learn how to make traditional dishes that exude the rich flavours of this land. Take part in live cookery demonstrations conducted by Mohara Dole, a passionate Sri Lankan food lover with a Malaysian background. Her vigour and zest will spark excitement in your heart as you mix and blend a variety of colourful spices to create a concoction of exquisite taste!
                    </p>
                        ...
                        <SwiperSlide>
                            <div className="group overflow-hidden rounded-xl shadow-lg">
                                ...
                                <div className="bg-[#083A5E] p-6 text-center">
                                    ...
                                    <button
                                        onClick={() => navigate(`/tours/special-interest-tours/walking-tours`)}
                        ...
                        <SwiperSlide>
                            <div className="group overflow-hidden rounded-xl shadow-lg">
                                ...
                                <div className="bg-[#083A5E] p-6 text-center">
                                    ...
                                    <button
                                        onClick={() => navigate(`/tours/special-interest-tours/bawa-tour`)}
                                        className="border-b-2 border-[#00A9C7] pb-1 text-sm uppercase tracking-widest text-[#00A9C7] hover:text-white">
                                        View Details
                                    </button>
                                </div>
                        ...
                        <SwiperSlide>
                            <div className="group overflow-hidden rounded-xl shadow-lg">
                                ...
                                <div className="bg-[#083A5E] p-6 text-center">
                                    ...
                                    <button
                                        onClick={() => navigate(`/tours/special-interest-tours/femina-tour`)}
                                        className="border-b-2 border-[#00A9C7] pb-1 text-sm uppercase tracking-widest text-[#00A9C7] hover:text-white">
                                        View Details
                                    </button>
                                </div>
...
export default CookingByColours;
