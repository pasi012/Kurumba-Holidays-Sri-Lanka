...
// Gallery images
import g1 from "../assets/Surfing.png";
import g2 from "../assets/colomboKithulgala1.jpg";
import g3 from "../assets/ella.jpg";
import g4 from "../assets/hurulupark.jpg";
      ...
      <div className="mx-auto max-w-[1536px] px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 pt-14 pb-6">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4 items-start">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="space-y-3 text-sm sm:text-[15px]">
              <div className="flex items-start justify-center gap-3 lg:justify-start">
                ...
                <span>kurumbaholidays@gmail.com</span>
              </div>
              ...
              <div className="flex items-start justify-center gap-3 lg:justify-start">
                ...
                <span>
                  384/121 Wakwella Road, Galle, Sri Lanka
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="text-center lg:text-left">
            ...
            {/* WhatsApp Button */}
            <a
              href="https://wa.me/94743412910?text=Hello%20I%20would%20like%20to%20book%20a%20vehicle"
              target="_blank"
